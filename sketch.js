...
function preload(){
  ...
  mangunImg=loadAnimation("images/mangun.png","images/mangun2.png");
  grassImg=loadImage("images/grass.png");
  girlfallImg=loadImage("images/girlfall.png");
...
function setup(){
 ...
 score=0;
  ...
  bg.addImage("background",sand);
   ...
   mangun=createSprite(player1.x-100,displayHeight-100,20,60);
   mangun.addAnimation("enemy",mangunImg);
   mangun.scale=2;
   console.log(mangun);
...
function draw(){
  ...
  if(gameState===1){
   ...
   if(player1.isTouching(pyramid)){
     player1.addImage("fall",girlfallImg);
   }

   if(player1.isTouching(pyramid2)){
     player1.addImage("fall2",girlfallImg);
   }

   if(player1.isTouching(pyramid3)){
     player1.addImage("fall3",girlfallImg)
   }
